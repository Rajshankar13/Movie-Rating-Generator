...
with open('movie_reviews/wall-street.json', ) as f:
	reviews = json.load(f)
...
with open('positive-words.txt', ) as f:
	positive_words = lemmatization(f.read().split())
...
with open('negative-words.txt', ) as f:
	negative_words = lemmatization(f.read().split())
...
print("Total reviews: ", len(lemmatized_reviews), "Positive Reviews: ", positive_reviews, 
